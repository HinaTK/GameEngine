...
INCPATH 	= INCROOTPATH + " -I " + PWD + " " + INCROOTPATH + "/lib/include";
SYSLIBS		= ""
LIBS		= LIBROOTPATH + "/lib/linux " + " -lFrame -lCommon -lThread" + SYSLIBS;
CXX			= "g++ -std=c++11";
FLAGS		= ' -g -Wall -pthread -D_GLIBCXX_USE_NANOSLEEP';

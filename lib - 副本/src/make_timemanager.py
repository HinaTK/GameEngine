...
INCPATH 	= INCROOTPATH + "/../" + " " + INCROOTPATH + "/include" + " " + INCROOTPATH + "/include/timemanager";
CXX			= "g++"
AR			= "ar cqs";
FLAGS		= "-fpic -g -c";

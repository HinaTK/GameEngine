...
/*
 * MONGOC_ENABLE_SECURE_CHANNEL is set from configure to determine if we are
 * compiled with Native SSL support on Windows
 */
#define MONGOC_ENABLE_SECURE_CHANNEL 1

#if MONGOC_ENABLE_SECURE_CHANNEL != 1
#  undef MONGOC_ENABLE_SECURE_CHANNEL
#endif

...
INCPATH 	= INCROOTPATH + "/../" + " " + INCROOTPATH + "/include" + " " + INCROOTPATH + "/include/common";
CXX			= "g++"
AR			= "ar cqs";
FLAGS		= '-g3 -Wall';
ARFLAGS		= '';
...
f.write("FLAGS				= " + FLAGS + "\n");
f.write("ARFLAGS			= " + ARFLAGS + "\n");
f.write("\n");

f.write("all:makedir $(OBJECTS)\n");
f.write("	$(AR) $(ARFLAGS) $(BIN) $(OBJECTS);\n");
f.write("\n");
